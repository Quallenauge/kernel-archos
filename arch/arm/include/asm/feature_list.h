...
/* 
   ...
   arcbuild/tools/mkfeaturelist/feature_list.h
   arcbuild/avboot-ng/include/asm-arm/feature_list.h
   arcbuild/linux/arch/arm/include/asm/feature_list.h
*/
 
#define TAGLIST_SECTION_NAME "tags"
...
#else
static inline void*get_feature_tag(u32 tag, u32 size)
{
	return NULL;
}
#endif
