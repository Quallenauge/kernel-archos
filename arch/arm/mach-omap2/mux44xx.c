...
static struct omap_mux __initdata omap4_core_muxmodes[] = {
	_OMAP4_MUXENTRY(GPMC_AD0, NO_GPIO, "gpmc_adNO_GPIO", "sdmmc2_datNO_GPIO", NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD1, NO_GPIO, "gpmc_ad1", "sdmmc2_dat1", NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD2, NO_GPIO, "gpmc_ad2", "sdmmc2_dat2", NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD3, NO_GPIO, "gpmc_ad3", "sdmmc2_dat3", NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD4, NO_GPIO, "gpmc_ad4", "sdmmc2_dat4",
			"sdmmc2_dir_dat0", NULL, NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD5, NO_GPIO, "gpmc_ad5", "sdmmc2_dat5",
			"sdmmc2_dir_dat1", NULL, NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD6, NO_GPIO, "gpmc_ad6", "sdmmc2_dat6",
			"sdmmc2_dir_cmd", NULL, NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_AD7, NO_GPIO, "gpmc_ad7", "sdmmc2_dat7",
			"sdmmc2_clk_fdbk", NULL, NULL, NULL, NULL, "safe_mode"),
	...
	_OMAP4_MUXENTRY(GPMC_NWP, 54, "gpmc_nwp", "dsi1_te0", NULL, "gpio_54",
			"sys_ndmareq1", NULL, NULL, "safe_mode"),
	...
	_OMAP4_MUXENTRY(GPMC_NOE, NO_GPIO, "gpmc_noe", "sdmmc2_clk", NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(GPMC_NWE, NO_GPIO, "gpmc_nwe", "sdmmc2_cmd", NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	...
	_OMAP4_MUXENTRY(CSI21_DX0, 67, "csi21_dx0", NULL, NULL, "gpi_67", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DY0, 68, "csi21_dy0", NULL, NULL, "gpi_68", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DX1, 69, "csi21_dx1", NULL, NULL, "gpi_69", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DY1, 70, "csi21_dy1", NULL, NULL, "gpi_70", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DX2, 71, "csi21_dx2", NULL, NULL, "gpi_71", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DY2, 72, "csi21_dy2", NULL, NULL, "gpi_72", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DX3, 73, "csi21_dx3", NULL, NULL, "gpi_73", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DY3, 74, "csi21_dy3", NULL, NULL, "gpi_74", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DX4, 75, "csi21_dx4", NULL, NULL, "gpi_75", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI21_DY4, 76, "csi21_dy4", NULL, NULL, "gpi_76", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI22_DX0, 77, "csi22_dx0", NULL, NULL, "gpi_77", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI22_DY0, 78, "csi22_dy0", NULL, NULL, "gpi_78", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI22_DX1, 79, "csi22_dx1", NULL, NULL, "gpi_79", NULL,
			NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI22_DY1, 80, "csi22_dy1", NULL, NULL, "gpi_80", NULL,
			NULL, NULL, "safe_mode"),
	...
	_OMAP4_MUXENTRY(I2C1_SCL, NO_GPIO, "i2c1_scl", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	_OMAP4_MUXENTRY(I2C1_SDA, NO_GPIO, "i2c1_sda", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	...
	_OMAP4_MUXENTRY(UNIPRO_TX2, NO_GPIO, "unipro_tx2", "kpd_col4", NULL,
			"gpio_0", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_TY2, 1, "unipro_ty2", "kpd_col5", NULL,
			"gpio_1", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_RX0, 175, "unipro_rx0", "kpd_row0", NULL,
			"gpi_175", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_RY0, 175, "unipro_ry0", "kpd_row1", NULL,
			"gpi_176", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_RX1, 177, "unipro_rx1", "kpd_row2", NULL,
			"gpi_177", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_RY1, 178, "unipro_ry1", "kpd_row3", NULL,
			"gpi_178", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_RX2, 2, "unipro_rx2", "kpd_row4", NULL,
			"gpi_2", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(UNIPRO_RY2, 3, "unipro_ry2", "kpd_row5", NULL,
			"gpi_3", NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(USBA0_OTG_CE, NO_GPIO, "usba0_otg_ce", NULL, NULL, NULL,
			NULL, NULL, NULL, NULL),
	...
	_OMAP4_MUXENTRY(SYS_NIRQ1, NO_GPIO, "sys_nirq1", NULL, NULL, NULL, NULL,
			NULL, NULL, "safe_mode"),
	...
	_OMAP4_MUXENTRY(DPM_EMU19, 191, "dpm_emu19", "dmtimer11_pwm_evt",
			...
			"hw_dbg19", "reserved"),
	_OMAP4_MUXENTRY(CSI22_DX2, NO_GPIO, "csi22_dx2", NULL, "cam2_fid",
			NULL, NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(CSI22_DY2, NO_GPIO, "csi22_dy2", NULL, "cam2_wen",
			NULL, NULL, NULL, NULL, "safe_mode"),				
...
static struct omap_mux __initdata omap4_wkup_muxmodes[] = {
	...
	_OMAP4_MUXENTRY(SIM_PWRCTRL, 4, "sim_pwrctrl", NULL, NULL, "gpio_wk4",
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(SR_SCL, NO_GPIO, "sr_scl", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	_OMAP4_MUXENTRY(SR_SDA, NO_GPIO, "sr_sda", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	_OMAP4_MUXENTRY(FREF_XTAL_IN, NO_GPIO, "fref_xtal_in", NULL, NULL, NULL,
			"c2c_wakereqin", NULL, NULL, NULL),
	_OMAP4_MUXENTRY(FREF_SLICER_IN, 5, "fref_slicer_in", NULL, NULL,
			"gpi_wk5", "c2c_wakereqin", NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(FREF_CLK_IOREQ, NO_GPIO, "fref_clk_ioreq", NULL, NULL, NULL,
			NULL, NULL, NULL, NULL),
	...
	_OMAP4_MUXENTRY(SYS_32K, NO_GPIO, "sys_32k", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	_OMAP4_MUXENTRY(SYS_NRESPWRON, NO_GPIO, "sys_nrespwron", NULL, NULL, NULL,
			NULL, NULL, NULL, NULL),
	_OMAP4_MUXENTRY(SYS_NRESWARM, NO_GPIO, "sys_nreswarm", NULL, NULL, NULL,
			NULL, NULL, NULL, NULL),
	_OMAP4_MUXENTRY(SYS_PWR_REQ, NO_GPIO, "sys_pwr_req", NULL, NULL, NULL, NULL,
			NULL, NULL, NULL),
	...
	_OMAP4_MUXENTRY(JTAG_NTRST, NO_GPIO, "jtag_ntrst", NULL, NULL, NULL, NULL,
			NULL, NULL, NULL),
	_OMAP4_MUXENTRY(JTAG_TCK, NO_GPIO, "jtag_tck", NULL, NULL, NULL, NULL, NULL,
			NULL, "safe_mode"),
	_OMAP4_MUXENTRY(JTAG_RTCK, NO_GPIO, "jtag_rtck", NULL, NULL, NULL, NULL,
			NULL, NULL, NULL),
	_OMAP4_MUXENTRY(JTAG_TMS_TMSC, NO_GPIO, "jtag_tms_tmsc", NULL, NULL, NULL,
			NULL, NULL, NULL, "safe_mode"),
	_OMAP4_MUXENTRY(JTAG_TDI, NO_GPIO, "jtag_tdi", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	_OMAP4_MUXENTRY(JTAG_TDO, NO_GPIO, "jtag_tdo", NULL, NULL, NULL, NULL, NULL,
			NULL, NULL),
	{ .reg_offset = OMAP_MUX_TERMINATOR },
};
	...
	struct omap_board_mux *board_wkup_subset, int flags)
{
	...
	/*
	 * if sysboot bits 6,7 both are 0, then the ioreq pin is INPUT
	...
	val &= OMAP2_SYSBOOT_6_MASK | OMAP2_SYSBOOT_7_MASK;
	if (!ret && !val)
