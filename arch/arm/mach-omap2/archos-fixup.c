...
/*
 * For now, set it to 1GByte Model
 */
static bool is512MByteArchosModel=false;
...
void __init fixup_archos(struct tag *tags, char **cmdline, struct meminfo *mi)
{
	struct tag *t = tags;
...
//	omapfb_set_platform_data(&tablet_fb_pdata);
	...
	printk("Starting tag resolution....");
	is512MByteArchosModel=true;
...
bool __init is512MbyteG9Model(void){
